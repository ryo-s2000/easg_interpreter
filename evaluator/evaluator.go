...
func evalHashLiteral(
	...
	for keyNode, valueNode := range node.Pairs {
		...
		if !ok {
			return newError("unsable as hash key: %s", key.Type())
		}
...
func evalHashExpression(hash, index object.Object) object.Object {
...
func evalInfixExpression(operator string, left, right object.Object) object.Object {
	...
	case left.Type() != right.Type():
		return newError("type mistmatch: %s %s %s", left.Type(), operator, right.Type())
...
func evalMinusPrefixOperatorExpression(right object.Object) object.Object {
	if right.Type() != object.INTEGER_OBJ {
		return newError("unknow operator: -%s", right.Type())
	}
